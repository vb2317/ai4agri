...
- Subtask 1 stays active because CodaBench gives immediate leaderboard feedback.
- Next RunPod work should target one optimized Subtask 1 candidate at a time, with local validation before every upload.
